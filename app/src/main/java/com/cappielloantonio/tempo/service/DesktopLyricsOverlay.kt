...
object DesktopLyricsOverlay {
    ...
    fun show(context: Context, currentLine: String?, nextLine: String?) {
    ...
    fun updateLyrics(currentLine: String?, nextLine: String?) {
        ...
        overlayView?.let { view ->
            ...
            currentTextView?.apply {
                text = currentLine ?: ""
                setTextColor(color)
                textSize = getFontSize(Preferences.getDesktopLyricsFontSize()).toFloat()
                visibility = if (currentLine.isNullOrEmpty()) android.view.View.GONE else android.view.View.VISIBLE
            }
            ...
            nextTextView?.apply {
                ...
                textSize = (getFontSize(Preferences.getDesktopLyricsFontSize()) * 0.7f)
                visibility = if (nextLine.isNullOrEmpty()) android.view.View.GONE else android.view.View.VISIBLE
            }
